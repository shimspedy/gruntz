import { appMuscles, getLibraryItem } from './exerciseLibrary';
...
/**
 * Exercise → clip in the bundled MoveKit library (assets/exercise-media, built by
 * scripts/build_exercise_media.sh). Every movement plays our own video; no external links.
 */
const EXERCISE_MEDIA: Record<string, string> = {
  air_squats: 'bodyweight-squat',
  ais_calf: 'single-leg-standing-calf-raise',
  ais_groin: 'cossack-squat',
  ais_hamstring: 'romanian-deadlift-hamstring-sweeps',
  ais_it_band: 'abdominals-stretch-variation-two',
  ais_middle_back: 'abdominals-stretch-variation-three',
  ais_quads: 'abdominals-stretch-variation-one',
  ais_rotator_cuff: 'band-external-rotation',
  ais_thoracic: 'bird-dog',
  ais_triceps: 'abdominals-stretch-variation-four',
  ammo_can_front_squats: 'dumbbell-goblet-squat',
  ammo_can_push_press: 'dumbbell-push-press',
  ammo_can_thruster: 'dumbbell-thruster',
  ankles_hips_shoulders: 'bodyweight-squat',
  back_squat: 'barbell-squat',
  backwards_hamstring: 'bodyweight-deadlift',
  band_assisted_pullup: 'band-assisted-pull-up',
  barbell_front_squat: 'front-squat',
  barbell_lunge: 'lunge-walking',
  barbell_thruster: 'barbell-thruster',
  base_arm_circles: 'band-external-rotation',
  base_chair_squats: 'bodyweight-box-squat',
  base_dead_bug: 'dead-bug',
  base_glute_bridge: 'glute-bridge',
  base_incline_pushups: 'incline-push-up',
  base_light_ruck_walk: 'hiking',
  base_low_stepups: 'dumbbell-step-up-low',
  base_march_in_place: 'running-cooldown',
  base_mobility_flow: 'bodyweight-spinal-jefferson-curl',
  base_single_leg_balance: 'single-leg-step-down',
  base_walk_10min: 'incline-treadmill-walk',
  base_walk_20min: 'incline-treadmill-walk',
  base_walk_30min: 'incline-treadmill-walk',
  base_walk_jog_intervals: 'running-intervals',
  base_wall_pushups: 'incline-push-up',
  bench_dips: 'bench-dips',
  bench_press: 'barbell-bench-press',
  bent_over_reverse_flys: 'dumbbell-rear-delt-fly',
  bent_over_rows: 'barbell-bent-over-row',
  bird_dog: 'bird-dog',
  bodyweight_hip_thrusts: 'glute-bridge',
  box_jumps: 'box-jump',
  broad_jumps: 'box-jump',
  burpees: 'burpee',
  butt_kicks: 'running-cooldown',
  butterfly_stretch: 'abdominals-stretch-variation-two',
  carry_choice_50m: 'kettlebell-farmers-carry',
  child_pose: 'abdominals-stretch-variation-four',
  chinups: 'chin-ups',
  close_grip_pushups: 'diamond-push-ups',
  conditioning_flush: 'rowing-machine-steady-state',
  conditioning_sprint_interval: 'assault-bike',
  cradles: 'bodyweight-alternating-reverse-lunges',
  db_curl_to_press: 'dumbbell-single-arm-clean-and-press',
  deadlift: 'barbell-deadlift',
  dips: 'parralel-bar-dips',
  dumbbell_getups: 'kettlebell-turkish-get-up',
  easy_pace_run: 'treadmill-run',
  elbow_pushups: 'front-plank',
  face_pulls: 'machine-face-pulls',
  farmers_carry: 'kettlebell-farmers-carry',
  float_4min: 'backstroke-swim',
  floor_prone_cobra: 'supermans',
  flutter_kicks: 'swim-kick-drill',
  foam_roll_adductors: 'cossack-squat',
  foam_roll_calves: 'single-leg-standing-calf-raise',
  foam_roll_lats: 'dead-hang',
  forward_plank: 'front-plank',
  frog_squat_warmup: 'dumbbell-sumo-squat',
  frog_squats: 'dumbbell-sumo-squat',
  goblet_squat: 'dumbbell-goblet-squat',
  gorilla_rows: 'kettlebell-gorilla-row',
  hand_release_pushups: 'push-up',
  hanging_leg_raises: 'hanging-knee-raises',
  high_crawl: 'mountain-climber',
  high_knees: 'mountain-climber',
  hip_bridge: 'glute-bridge',
  hip_thrusts: 'barbell-hip-thrust',
  inchworm: 'hand-plank',
  inverted_rows: 'inverted-row',
  jog_100_200m: 'running-cooldown',
  jumping_jacks: 'jumping-jack',
  kb_swings: 'kettlebell-swing',
  knees_to_elbows: 'toes-to-bar',
  lat_hang_stretch: 'dead-hang',
  lat_pulldown: 'lat-pulldown',
  lateral_lunge: 'dumbbell-lateral-lunge',
  light_bent_over_row: 'barbell-bent-over-row',
  light_overhead_press: 'barbell-overhead-press',
  light_squat: 'barbell-squat',
  locomotive_choice_50m: 'mountain-climber',
  lunges_counter_rotation: 'forward-lunge',
  modified_pushups: 'bodyweight-knee-push-ups',
  mountain_climbers: 'mountain-climber',
  overhead_press: 'barbell-overhead-press',
  partner_drags: 'sled-pull',
  pft_run: 'tempo-run',
  pike_pushup: 'decline-push-up',
  pinch_grip_plate_carry: 'plate-pinch',
  plank_walkup: 'hand-plank',
  prisoner_squat: 'bodyweight-squat',
  pullups: 'pull-ups',
  pushups: 'push-up',
  pyramid_track: 'running-intervals',
  rdl: 'barbell-romanian-deadlift',
  rear_lunge_warmup: 'bodyweight-reverse-lunge',
  recovery_swim: 'backstroke-swim',
  reverse_crunch_rotation: 'v-up',
  roller_full: 'abdominals-stretch-variation-one',
  ruck_10mi: 'hiking',
  ruck_12mi: 'hiking',
  ruck_1_2mi: 'hiking',
  ruck_2mi_heavy: 'hiking',
  ruck_3mi_heavy: 'hiking',
  ruck_4mi: 'hiking',
  ruck_4mi_35: 'hiking',
  ruck_4mi_35_fast: 'trail-run',
  ruck_5mi: 'hiking',
  ruck_5mi_35: 'hiking',
  ruck_6mi: 'hiking',
  ruck_6mi_35: 'hiking',
  ...
  ruck_8mi: 'hiking',
  ruck_9mi: 'hiking',
  run_1000m_repeats: 'running-intervals',
  run_1600m_repeats: 'running-intervals',
  run_1_5mi: 'treadmill-run',
  run_3mi: 'long-run',
  run_400m_repeats: 'running-intervals',
  run_800m_repeats: 'running-intervals',
  running_buildups: 'running-intervals',
  russian_twist: 'bodyweight-russian-twist',
  sandbag_getups: 'kettlebell-turkish-get-up',
  side_plank: 'elbow-side-plank',
  single_leg_rdl: 'single-legged-romanian-deadlifts',
  skaters: 'cossack-squat',
  sled_drag: 'sled-pull',
  sled_drag_choice_50m: 'sled-push',
  sled_pull_backwards: 'sled-pull',
  sled_push_quick: 'sled-push',
  split_squats: 'barbell-split-squat',
  sprint_200m: 'running-intervals',
  sprint_400m: 'running-intervals',
  sprint_800m: 'running-intervals',
  squat_jump: 'jump-squats',
  standing_tubing_row: 'band-row',
  straight_arm_plank: 'hand-plank',
  straight_arm_pulls: 'straight-arm-lat-pulldown',
  strict_chinups: 'chin-ups',
  strict_pullup: 'pull-ups',
  strict_pushups: 'push-up',
  strict_situps: 'decline-sit-up',
  strict_standing_press: 'barbell-overhead-press',
  swim_100m: 'freestyle-swim',
  swim_200m: 'freestyle-swim',
  swim_25m: 'freestyle-swim',
  swim_300m: 'swim-sprint-intervals',
  swim_500m: 'swim-sprint-intervals',
  swim_50m: 'freestyle-swim',
  swim_800m: 'freestyle-swim',
  tempo_run_mid: 'tempo-run',
  tempo_run_short: 'tempo-run',
  thoracic_rotations: 'cable-wood-chopper',
  tire_flips: 'power-clean',
  tread_hands_up: 'swim-kick-drill',
  tread_water: 'breaststroke-swim',
  turkish_getup: 'kettlebell-turkish-get-up',
  underwater_swim: 'breaststroke-swim',
  usmc_crunches: 'decline-crunch',
  walking_ammo_can_lunge: 'lunge-walking',
  walking_high_knees: 'running-cooldown',
  walking_lunges: 'lunge-walking',
  walking_quads_pulls: 'forward-lunge',
  weighted_rear_lunges: 'dumbbell-goblet-reverse-lunge',
  weighted_step_up: 'barbell-step-up-knee-drive',
  worlds_greatest_stretch: 'bodyweight-alternating-lateral-lunge',
};
...
exercises.forEach(ex => {
  ...
  ex.media_key = EXERCISE_MEDIA[ex.id];
});
...
export const libraryExerciseId = (key: string) => `${LIBRARY_PREFIX}${key}`;

/** A library clip as a full Exercise, so the live session can run it like any program movement. */
function libraryExercise(key: string): Exercise | undefined {
  const cached = libraryCache.get(key);
  if (cached) return cached;
  const item = getLibraryItem(key);
  if (!item) return undefined;
  const timed = item.group === 'cardio' || item.group === 'swim' || item.pattern.includes('Stretch') || item.pattern.includes('Mobility');
  const ex: Exercise = {
    id: libraryExerciseId(key),
    name: item.name,
    category:
      item.group === 'swim' ? 'swimming' : item.group === 'cardio' ? 'running' : item.group === 'mobility' ? 'recovery' : item.pattern.includes('Core') ? 'core' : 'strength',
    ...
    muscle_groups: appMuscles(item),
    media_key: key,
  };
  libraryCache.set(key, ex);
  return ex;
}

export function getExerciseById(id: string): Exercise | undefined {
  if (id.startsWith(LIBRARY_PREFIX)) return libraryExercise(id.slice(LIBRARY_PREFIX.length));
